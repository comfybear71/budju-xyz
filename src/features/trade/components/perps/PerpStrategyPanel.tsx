    ...
    <div className="space-y-3">
      ...
      <div className="bg-slate-800/20 rounded-lg p-2.5 border border-white/[0.02]">
        <div className="text-[10px] text-slate-500 space-y-1">
          ...
          <p><strong className="text-slate-400">Data needed:</strong> ~{status.min_candles_required} minutes of price data before strategies activate. Collecting automatically.</p>
        </div>
      </div>
    </div>
  );
