...
const NFTHero = () => {
  ...
  return (
    <section ref={heroRef} className="pt-28 pb-16 overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="w-full lg:w-1/2 lg:pr-6 z-10">
            ...
            >
              ...
              <p
                className={`text-xl ${isDarkMode ? "text-gray-300" : "text-white"} mb-8`}
              >
              ...
              <p className="text-lg text-budju-blue mb-8">
                <span
                  className={`font-bold ${isDarkMode ? "text-white" : "text-budju-white"}`}
                >
                  Coming Soon:
                </span>{" "}
                Mint your very own BUDJU character once we reach 1,000 token
                holders!
              </p>
          ...
          <div ref={imagesRef} className="w-full lg:w-1/2 relative h-96 z-0">
            <div className="absolute top-0 left-0 w-60 h-60 perspective-1000">
              <img
                ...
                alt="BUDJU NFT 1"
                className={`w-full h-full object-contain rounded-xl shadow-lg border-2 ${isDarkMode ? "border-gray-800" : "border-white/30"}`}
              />
            </div>
