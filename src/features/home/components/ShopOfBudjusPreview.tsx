              ...
              <div className="absolute bottom-4 left-0 right-0 flex justify-center gap-2">
                {shopImages.map((_, index) => (
                  <button
                    ...
                    className={`w-3 h-3 rounded-full transition-all hover:scale-150 ${currentIndex === index ? "bg-budju-pink scale-125" : isDarkMode ? "bg-gray-600 hover:bg-gray-400" : "bg-gray-400 opacity-70 hover:opacity-100"}`}
